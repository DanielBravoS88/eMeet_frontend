...
export interface Event {
  ...
  lng?: number
  audioPreviewUrl?: string | null  // URL de preview 30s de Deezer (efímera — caduca)
  audioTrackId?: string | null     // ID estable de la canción en Deezer (para re-resolver el preview)
}
